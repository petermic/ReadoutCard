...
static constexpr Register SCA_WR_DATA(0x0000e130);
static constexpr Register SCA_WR_CMD(0x0000e130);
static constexpr Register SCA_WR_CTRL(0x0000e120);

static constexpr Register SCA_RD_DATA(0x0000e150);
static constexpr Register SCA_RD_CMD(0x0000e150);
static constexpr Register SCA_RD_CTRL(0x0000e140);
static constexpr Register SCA_RD_MON(0x00f0001c);

static constexpr Register SC_LINK(0x0000e100);
static constexpr Register SC_RESET(0x0000e110);

static constexpr Register SWT_WR_WORD_L(0x0000e160);
static constexpr Register SWT_WR_WORD_M(0x0000e164);
static constexpr Register SWT_WR_WORD_H(0x0000e168);

static constexpr Register SWT_RD_WORD_L(0x0000e180);
static constexpr Register SWT_RD_WORD_M(0x0000e184);
static constexpr Register SWT_RD_WORD_H(0x0000e188);

static constexpr Register SWT_CMD(0x0000e170);
static constexpr Register SWT_MON(0x0000e180);
